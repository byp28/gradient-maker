    ...
    className='fixed z-10 top-0 left-0 w-full h-full bg-gray-800/95 flex justify-center items-center'>
      <div onClick={e=> e.stopPropagation()} className='max-w-[500px] rounded p-7 bg-gray-50'>
        <div className='flex items-center mb-5'>
          <p className='font-semibold mr-6 text-gray-950'>Here is your code 🎉</p>
          <button onClick={handleCopy} className='ml-auto mr-2 text-sm bg-blue-600 text-white hover:bg-blue-700 py-1 px-3 rounded'>Copy</button>
